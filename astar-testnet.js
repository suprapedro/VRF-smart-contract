...
async function main() {
    const contracts  = {
        deposit: '0x5427Ddf5e255609dc061B1e46f032D337ea3ABAd',
        generator: '0x3B5F96986389f6BaCF58d5b69425fab000D3551e',
        router: '0x1697F96d52DFB51CcC96856680DA885c8AdAe429',
        rng: ''
    }
    const providerClient = await new EVM({ privateKey, networkName: 'astar', networkType: 'testnet', contracts });
