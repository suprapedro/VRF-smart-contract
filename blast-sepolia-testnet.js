...
async function main() {
    const contracts  = {
        ...
        generator: '0x4B3311F0F2f61764d276E5De203754cf9D5c13b5',
        router: '0x2c9e897Ed7d4B1a917046c0d5B0770FE6094A181',
        rng: ''
    }
    const providerClient = await new EVM({ privateKey, networkName: 'blast_sepolia', networkType: 'testnet', contracts });
