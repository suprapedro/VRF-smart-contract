...
async function main() {
    const contracts  = {
        deposit: '0x3B5F96986389f6BaCF58d5b69425fab000D3551e',
        generator: '0xcF99ab8c2AABC04349139484BAFC26f480Ef4cE4',
        router: '0x99a021029EBC90020B193e111Ae2726264a111A2',
        rng: ''
    }
    const providerClient = await new EVM({ privateKey, networkName: 'base_sepolia', networkType: 'testnet', contracts });
