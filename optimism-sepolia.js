...
async function main() {
    const contracts  = {
        ...
        generator: '0x430d3842aB7a10E7004bf1079c0749EBE0BF1793',
        router: '0x6D46C098996AD584c9C40D6b4771680f54cE3726',
        rng: ''
    }
    const providerClient = await new EVM({ privateKey, networkName: 'optimism_sepolia', networkType: 'testnet', contracts });
