...
async function main() {
    const contracts  = {
        deposit: '0xAf2412A54E2aaC5468bAf416983a50B97e0acaAB',
        generator: '0xA116AFA6C9979F96797D9A7cAc8180D9b78c81E9',
        router: '0xec5Ad2091b972583Db77D986567be41d58dF5a3E',
        rng: ''
    }
    const providerClient = await new EVM({ privateKey, networkName: 'klaytn', networkType: 'mainnet', contracts });
