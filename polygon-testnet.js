...
async function main() {
    const contracts  = {
        ...
        generator: '0xE1857a6F2695cac6871643A6cC84Ff902Fa8894d',
        router: '0x7D63aa8468e8c4c60395AD423271f45Bb34dF0fd',
        rng: ''
    }
    const providerClient = await new EVM({ privateKey, networkName: 'polygon', networkType: 'testnet', contracts });
