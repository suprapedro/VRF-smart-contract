...
async function main() {
    const contracts  = {
        ...
        generator: '0x3Da22f07080EbC997C28AE1f5377141D86b198fd',
        router: '0xF65754b4988aD9ff25E0f2980f645A02eEB73A5D',
        rng: ''
    }
    const providerClient = await new EVM({ privateKey, networkName: 'bnb', networkType: 'testnet', contracts });
